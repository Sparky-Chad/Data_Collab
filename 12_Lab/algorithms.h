...
*/
    ...
    // This is going to be a templated version of the counting algorithm
    // if this does work I will likely comment out the old one.
    template <class T>
    void counting(T* arr, int size)
    {
        int max_size = -1;
        for(int i = 0; i < size; i++)
        {
